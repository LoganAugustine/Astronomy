...
# Plot 1
plt.xscale('log')
plt.plot(zcmb, TDM1, zorder=5, label=r'$\Omega_M = 0.3, \Omega_\Lambda = 0.7$', linewidth=3)
plt.plot(zcmb, TDM2, zorder=5, label=r'$\Omega_M = 1.0, \Omega_\Lambda = 1.0$', linewidth=2)
plt.plot(zcmb, TDM3, zorder=5, label=r'$\Omega_M = 0.3, \Omega_\Lambda = 0.0$', linewidth=2)
plt.scatter(zcmb, DM, color='slategray', edgecolors='none', alpha=0.4, zorder=1)
plt.errorbar(zcmb, DM, color='slategray', yerr=dmb, fmt="o", alpha=0.4)
plt.legend()
plt.show()
...
# Plot 2
plt.xscale('log')
plt.scatter(zcmb, Diff1, edgecolors='none', alpha=0.4)
plt.scatter(zcmb, Diff2, edgecolors='none', alpha=0.4)
plt.scatter(zcmb, Diff3, edgecolors='none', alpha=0.4)
plt.ylim((-1.2, 0.5))
plt.show()
